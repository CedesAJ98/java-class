...
public class LlmasWhalesAndDodosOhMy {
    public static void main (String [] args){
        ...
        if(llamas > whales) {
            System.out.println("Whales may be be bigger, but llamas are better, ha!");
        }
        if (llamas <= whales) {
        ...
        if ( llamas > whales && llamas < dodos){
            System.out.println("I don't know, but the llamas have come out a head! Sneaky!");
        }
    }
}
